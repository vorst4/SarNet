...
class ResNetAE6(nn.Module, ABC):
    ...
    def __init__(self):
        ...
        kernels = [int(np.round(((ii+1) * (par / res[ii]**2)/depth))) for ii in range(depth)]
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose2d(kernels[4], kernels[4], kernel_size=2, stride=2, padding=0, bias=True),
            nn.ReLU(),
